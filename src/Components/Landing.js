...
function Landing() {
    return (
        <div className="h-screen bg-green-50 pt-48 z-200">
            <div className="container mx-auto text-center">
                <div className="text-4xl"> Hello! Welcome to my site!</div>
                ...
                <button className="mt-4 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
                ...
                <img src="color pencil.png" className="overflow-hidden"></img>
            </div>
        </div>
    )
}
